...
<!-- wp:search {"label":"<?php echo esc_html_x( 'Search', 'label', 'memberblocks' ); ?>","placeholder":"<?php echo esc_attr_x( 'Search...', 'placeholder for search field', 'memberblocks' ); ?>","showLabel":false,"buttonText":"<?php esc_attr_e( 'Search', 'memberblocks' ); ?>","buttonUseIcon":true} /-->
